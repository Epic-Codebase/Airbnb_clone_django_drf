...
#Hard coded for deployment by now
ALLOWED_HOSTS = ['137.184.235.176']#os.environ.get('DJANGO_ALLOWED_HOSTS', '').split(' ')
...
if DEBUG:
    ...
    WEBSITE_URL = 'http://137.184.235.176:1337'
...
SIMPLE_JWT = {
    "ACEESS_TOKEN_LIFETIME": timedelta(minutes=60),
